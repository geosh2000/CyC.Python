...
print "Obtaining %s..." % 'Agents Details CO',
try:
    ...
    for idx, row in enumerate(data):
        ...
        # query = "INSERT INTO ccexporter.agentDetails %s VALUES %s ON DUPLICATE KEY UPDATE asesor=GETIDASESOR(VALUES(descr_agente),2), %s" % (keys, vals, update)
