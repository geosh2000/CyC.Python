...
updateFlag = "UPDATE ccexporter.liveMonitorMX SET updateFlag = 0"
...
for item in agents:
    ...
    query = "INSERT INTO ccexporter.liveMonitorMX (updateFlag, %s) VALUES (1, %s) ON DUPLICATE KEY UPDATE updateFlag=1, %s;" % (fieldQ, valQ, dupQ)
    # print query
    curEx.execute( query )
...
updateFlag = "UPDATE ccexporter.liveMonitorMX SET obCaller = NULL, obTst= NULL, %s WHERE updateFlag = 0" % updQ
curEx.execute( updateFlag )
dbEx.commit()
print "Done!"
curEx.close()
